...
void qorus_qctl(bool qorus_dbg_internals, QoreProgram* qpgm, ExceptionSink* xsink);
...
int main(int argc, char* argv[]) {
   ...
   for (unsigned i = 0; i < NUM_INT_MODULES; ++i) {
    ...
    qorus_qctl(qorus_dbg.internals, qpgm, &xsink);
